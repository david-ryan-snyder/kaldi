...
run.pl ${plda_ivec_dir}/log/compute_mean.log \
  ivector-mean scp:${plda_ivec_dir}/ivector.scp ${plda_ivec_dir}/mean.vec || exit 1;
run.pl ${plda_ivec_dir}_male/log/compute_mean.log \
  ivector-mean scp:${plda_ivec_dir}_male/ivector.scp ${plda_ivec_dir}_male/mean.vec || exit 1;
run.pl ${plda_ivec_dir}_female/log/compute_mean.log \
  ivector-mean scp:${plda_ivec_dir}_female/ivector.scp ${plda_ivec_dir}_female/mean.vec || exit 1;
