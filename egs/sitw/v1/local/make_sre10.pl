...
#open(TRIALS, "<", "$db_base/keys/core-core.trialkey.csv") || die "Could not open $db_base/keys/core-core.trialkey.csv";
open(TRAIN, "<", "$db_base/train/coreext.trn") || die "Could not open $db_base/train/coreext.trn";
#open(TRAIN, "<", "$db_base/train/core.trn") || die "Could not open $db_base/train/core.trn";
open(MODELS, "<", "$db_base/keys/coreext.modelkey.csv") || die "Could not open $db_base/keys/coreext.modelkey.csv";
#open(MODELS, "<", "$db_base/keys/core.modelkey.csv") || die "Could not open $db_base/keys/core.modelkey.csv";
